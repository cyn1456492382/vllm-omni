...
class AsyncOmniEngine:
    ...
    def _create_default_diffusion_stage_cfg(kwargs: dict[str, Any]) -> list:
        ...
        stage_engine_args = {
            ...
            "max_cpu_loras": kwargs.get("max_cpu_loras", None),
            "max_gpu_loras": kwargs.get("max_gpu_loras", None),
            "enable_mixed_lora_batch": kwargs.get("enable_mixed_lora_batch", False),
